  ...
  const features = [
    {
      ...
      description:
        "Automate product tagging with configurable rules for Just In, Best Seller, Limited Stock, and more.",
    },
    {
      icon: Sparkles,
      title: "AI-Powered Tags",
      description:
        "Let AI analyze your products and suggest high-volume search terms to boost discoverability.",
    },
    {
      icon: TrendingUp,
      title: "Best Seller Tracking",
      description:
        "Automatically tag your top-performing products based on sales data and location filters.",
    },
    {
      icon: Zap,
      title: "Real-Time Updates",
      description:
        "Tags are updated automatically based on inventory levels, publish dates, and sales performance.",
    },
    {
      icon: Shield,
      title: "Misspelt Tag Protection",
      description:
        "Capture common typos and misspellings to ensure customers find what they're looking for.",
    },
    {
      icon: BarChart3,
      title: "Analytics Dashboard",
      description:
        "Track tagging performance with detailed logs, metrics, and actionable insights.",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed ">
              Boost product discoverability and sales with intelligent,
              rule-based tagging for your Shopify store.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to automate product tagging and increase
              conversions
            </p>
          </div>
